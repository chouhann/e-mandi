...
<head>
    ...
    <title>500 Server Error - E-Mandi</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .error-container .error-code { font-size: 120px; font-weight: bold; color: #e74c3c; margin-bottom: 10px; }
...
<body>
    <div class="error-container">
        ...
        <a href="${pageContext.request.contextPath}/contact" class="btn">
